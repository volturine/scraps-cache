...
> **Historical design document.** This plan was implemented (see status below).
> For current operator and contributor docs, use [README.md](../../README.md),
> [architecture.md](../architecture.md), [security.md](../security.md), and
> [self-hosting.md](../self-hosting.md).

## Implementation status

Implemented on 2026-07-30. The application check, automated tests, SQLite
